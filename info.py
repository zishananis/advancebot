...
REQ_CHANNEL = environ.get('REQ_CHANNEL','-1002548035418')
...
SHORTENER_API = environ.get("SHORTENER_API", "e7e60b60c0cb8f30135bd74467525a97c9cebc4b")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'yummyurl.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "e7e60b60c0cb8f30135bd74467525a97c9cebc4b")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'yummyurl.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "e7e60b60c0cb8f30135bd74467525a97c9cebc4b")
...
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/KCA.jpg')).split()
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/KCA.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡", "🥳"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "http://209.74.86.88:5000/")
