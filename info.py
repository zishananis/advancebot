...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6942557751 5446981726').split()]
USERNAME = environ.get('USERNAME', "https://t.me/zishananis_official") # ADMIN USERNAME WITH https://
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002340773096'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/filmsexpert2') # WITH https://
