...
async def stream_start(client, message):
    ...
    if msg.media in [enums.MessageMediaType.VIDEO, enums.MessageMediaType.DOCUMENT]:
        ...
        await message.reply_text(text=msg_text.format(get_name(log_msg), humanbytes(get_media_file_size(log_msg)), download, stream), quote=True, disable_web_page_preview=True, reply_markup=rm)
